...
import yberkutImg from './assets/yberkut.png';
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center mb-8">
            <img 
              src={yberkutImg}
              alt="Yuliia Berkut"
              className="rounded-full w-32 h-32 object-cover border border-gray-200"
            />
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <a href="tel:+14161234567" className="text-gray-600 hover:text-emerald-600 transition-colors">
                (647) 571-1536
              </a>
            </div>
          </div>
